...
| `src/synth.ts` | Web Audio instrument for hearing the keyboard through the computer: two oscillators per note, piano-like envelope, sustain pedal, latency readout |
